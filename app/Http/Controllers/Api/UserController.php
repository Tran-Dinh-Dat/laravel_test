...
use App\LaravelPermission\Models\Permission;
use App\LaravelPermission\Models\Role;
use App\LaravelPermission\Models\User;
...
class UserController extends BaseController
{
    ...
    public function update(Request $request, User $user)
    {
        ...
        if (!$currentUser->isAdmin()
            ...
            && !$currentUser->hasPermission(\App\LaravelPermission\Acl::PERMISSION_USER_MANAGE)
        ) {
